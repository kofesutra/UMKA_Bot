# def get_text_resume_2(IMT, MASS, KCAL_NORM, KCAL_MIN, DIFF_CAL, WATER, PROTEIN, FAT, CARBO):

subject_email_second_bonus = 'Второй подарок от бота канала "Королевы Калорий"'

text_email_second_bonus = f"""
<!DOCTYPE html>
          ...
          sans-serif;font-size:14px;line-height:15px;">
            ...
            <tr>
              <td style="padding:10px;background-color:#ffffff;">
                ...
                -bottom:2px solid #f0f0f5;color:#19738d;"><b>Второй бонус от бота канала "Королевы Калорий"</b></p> 

                <p style="margin:10;border-bottom:2px solid #f0f0f5;">   </p>

                <p style="margin:10;"><b>Здравствуйте!</b>
                <p style="margin:10;"><b>Высылаю Вам второй бонус, который Вы заказывали.</p>

                <p style="margin:10;"><b>Ваши друзья, которым Вы отправляли пригласительную ссылку, тоже пользуются УМКА-ботом.</p>
    
                <p style="margin:10;">Ваш подарок приложен к этому письму.</p> 
                
                <p style="margin:10;">Благодарю Вас за доверие!</p> 
                </td> </tr> 
